...
def build_hourly_dataframe(pd, values, start_date: datetime, value_col: str):
...
def build_daily_dataframe(pd, values, dates, value_col: str, start_dt: datetime, end_dt: datetime):
